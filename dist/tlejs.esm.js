...
function getOrbitTrackSync3D({
  ...
  while (!isDone) {
    const curLngLat = getLngLat(tleArr, curTimeMS); // Calculate satellite height in meters
...
function getGroundTracksSync3D({
  tle,
  stepMS = 1000,
  optionalTimeMS = Date.now(),
  // TODO: change to startTimeMS for consistency
